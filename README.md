...
Project data are available on [OSF](https://osf.io/fx6ke/) in the folders: Preprocessed_data, volume_stats. The iEEG and MRI data were prepared for analysis using the [pipeline for iEEG data curation](https://github.com/elizljohnson-projects/pipeline-ieeg-data-curation.git). Project data include processed aperiodic slope, gray matter volume, memory task performance, and demographic data.
...
Notes:
- Project data contain the aperiodic slopes generated using the IRASA scripts in Python.
